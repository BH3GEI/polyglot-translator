...
var CerebrasError = class extends Error {
};
var APIError = class _APIError extends CerebrasError {
  ...
  create(params, options) {
    ...
    return this._client.post("/v1/chat/completions", {
      ...
      headers: {
        ...
        ...(xDelayTime == null ? void 0 : xDelayTime.toString()) != null ? { "X-delay-time": xDelayTime == null ? void 0 : xDelayTime.toString() } : void 0,
...
var _a;
var Cerebras = class extends APIClient {
  /**
...
var cerebras_cloud_sdk_default = Cerebras;
export {
  APIConnectionError,
  ...
  cerebras_cloud_sdk_default as default,
  fileFromPath,
  toFile
};
//# sourceMappingURL=@cerebras_cerebras_cloud_sdk.js.map
